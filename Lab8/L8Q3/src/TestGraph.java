public class TestGraph {
    public static void main(String[] args) {
        ...
        System.out.println("Remove edge from Alor Setar to Kuching: " + graph1.removeEdge("Alor Setar","Kuching"));
        System.out.println("Remove edge from Penang to Langkawi: " + graph1.removeEdge("Penang","Langkawi"));
        System.out.println();
